...
function addEvent() {
    event.push({title:document.getElementById("title").innerHTML,description:document.getElementById("title").innerHTML,time:document.getElementById("title").innerHTML ,date:document.getElementById("title").innerHTML,color:"red" })
