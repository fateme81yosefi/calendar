...
function addEvent() {
    event.push({title:document.getElementById("title").innerHTML,description:document.getElementById("title").innerHTML,time:document.getElementById("title").innerHTML ,date:"2023/12/31",color:"red" })
